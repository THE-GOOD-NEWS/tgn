      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div dir={isRTL ? "rtl" : "ltr"} className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <motion.h2
            ...
            className={`text-3xl sm:text-5xl lg:text-6xl font-black text-white leading-tight ${isRTL ? "font-arabic-header" : "font-english-header"
              }`}
          >
            {t("title")}
          </motion.h2>
          ...
          <motion.p
            ...
            className={`text-base sm:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed ${isRTL ? "font-arabic-body" : "font-english-body"
              }`}
          >
            {t("subtitle")}
          </motion.p>
          ...
          >
            <Link
              ...
              className={`px-8 py-4 sm:px-10 sm:py-5 rounded-2xl text-base sm:text-lg font-bold text-gray-900 bg-gradient-to-r from-hot-pink via-purple to-bright-yellow shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 button-glow ${isRTL ? "font-arabic-subheading" : "font-english-subheading"
                }`}
            >
